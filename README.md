...
- Allow a user to enter a search string and submit a search request. JACOB 
- Query the `Giphy API Search Endpoint` with the given search string **FROM THE SERVER**. ROB
- Display the results on the DOM. ROB 
